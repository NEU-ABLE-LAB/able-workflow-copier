...
TODO-copier-package overview of the features concept. tldr; *datasets* have many columns and many rows, *features* have many fewer columns and/or rows, and/or go through significant transformation.
